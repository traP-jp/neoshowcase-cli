...
func (e *Executor) List(ctx context.Context, options model.Connection) (appmodel.ListResult, error) {
	...
	if err != nil {
		return appmodel.ListResult{}, client.RPCError("list applications", err)
	}
